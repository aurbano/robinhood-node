...
type ReplaceLastParam<
  F extends (...args: unknown[]) => unknown,
  W
> = Parameters<F> extends [infer B, infer M, infer E]
  ? (Error: B, Request: M, Body: W) => ReturnType<F>
  : never;
...
declare namespace robinhood {
  ...
  export type IntervalTypes = "5minute" | "10minute" | "day" | "week" | "month";

  export type SpanTypes = "day" | "week" | "month" | "year" | "5year";

  export namespace JSONResponse {
    type historicals = Partial<{
      [key: string]: unknown;
      /** https url string */
      quote: string;
      symbol: string;
  ...
  export interface RobinhoodWebApi {
    ...
    historicals(
      ...
      intv: IntervalType,
      span: SpanType,
      callback: ReplaceLastParam<
        request.RequestCallback,
        JSONResponse.historicals
      >
    ): void;
